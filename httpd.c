...
void
	httpd_init(void) {
		...
		PIN_UNUSED(j1[0]);
		PIN_UNUSED(j1[1]); // PB5 -- ENC28J60 Chip Select
		...
		PIN_UNUSED(j1[4]); // PE4 -- ENC28J60 Interrupt
		PIN_UNUSED(j1[5]); // PE5
		//SETUP_PIN(j1[6], GPIO_PORTB_BASE, GPIO_PIN_4, CONFIG_INPUT);
		PIN_UNUSED(j1[6]); // PB4 -- SSI2 CLK
		PIN_UNUSED(j1[7]); // PA5
		...
		PIN_UNUSED(j2[5]); // PB7 -- SSI2 TX
		PIN_UNUSED(j2[6]); // PB6 -- SSI2 RX
		//SETUP_PIN(j2[5], GPIO_PORTB_BASE, GPIO_PIN_7, CONFIG_INPUT);
		//SETUP_PIN(j2[6], GPIO_PORTB_BASE, GPIO_PIN_6, CONFIG_INPUT);
